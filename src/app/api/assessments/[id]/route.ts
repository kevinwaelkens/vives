...
export async function PATCH(
  ...
  try {
    ...
    const assessment = await prisma.assessment.update({
      ...
      data: {
        ...validatedData,
        gradedAt: validatedData.gradedAt
          ? new Date(validatedData.gradedAt)
          : undefined,
    ...
    // Note: Notifications would be created for tutors/admins, not students
    // since students don't have user accounts in this system
