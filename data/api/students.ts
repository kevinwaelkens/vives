...
export const studentsApi = {
  ...
  getStudents: async (filters?: StudentFilters): Promise<PaginatedResponse<StudentWithRelations>> => {
    ...
    return apiClient.get<PaginatedResponse<StudentWithRelations>>(url)
  },
